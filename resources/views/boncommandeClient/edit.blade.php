...
<div class="card">
  ...
  <div class="card-body">
      ...
      <form action="{{ url('boncommandeclient/' .$bon_commande_client->id) }}" method="post">
        ...
        <input type="text" name="desc" id="desc" value="{{$bon_commande_client->desc}}" class="form-control"></br>
        <label>Date de création</label></br>
        <input type="date" name="dat_com" id="dat_com" value="{{$bon_commande_client->dat_com}}" class="form-control"></br>
        <label>Date d'expiration</label></br>
        <input type="date" name="dat_exp" id="dat_exp" value="{{$bon_commande_client->dat_exp}}" class="form-control"></br>
