                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="invoice-to mt25">
                            <ul class="list-unstyled">
                                ...
                                <li>Téléhpone :(216) {{$boncommande_clients->num_tel ?? $client->num_tel }}</li>
                                <li>Adresse :  {{$boncommande_clients->adresse_cli ?? $client->adresse_cli }}</li> 
