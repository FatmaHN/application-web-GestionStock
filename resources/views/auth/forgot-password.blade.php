...
<!-- Mirrored from codeigniter.spruko.com/azea/ltr/pages/forgot-password-1 by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 23 Jan 2022 19:09:21 GMT -->
...
<head>
		...
		<!-- Title -->
		<title>Application de gestion des stocks</title>
												...
												<div class="col-lg-6 p-0">
													<div class="text-justified text-white p-5 register-1  overflow-hidden">
														<div class="custom-content">
															<div class="mb-5 br-7">
																<img src="../assets/images/brand/gt_1.png" class="header-brand-img desktop-lgo" alt="capitol soft">
																<br>
																<hr>
															</div>
															<div class="ms-5">
																...
																<div class="mb-6 text-white-50">
																	Mot de passe oublié? <br>Aucun problème. Indiquez-nous simplement votre adresse e-mail et nous vous enverrons par e-mail un lien de réinitialisation de mot de passe qui vous permettra de en choisir un nouveau mot de passe.
																</div>
												...
												<div class="bg-white text-dark br-7 br-tl-0 br-bl-0">
                                                    ...
                                                    <x-auth-validation-errors class="mb-4" :errors="$errors" />
														<div class="text-center mb-3">
															...
															<a><h4>OOps....</h4></a>
															<h3><hr class="hrregister3"></h3>
															<div>Entrer votre E-mail</div>
															<br>
                                                        ...
                                                        @csrf
                                                            ...
                                                            <button type="submit" class="btn btn-outline-dark  btn-block d-grid px-4 font-weight-bold">Envoyer</button>
														    </div>
