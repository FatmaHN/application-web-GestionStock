...
@if ($message = Session :: get ('msgfail')) 
    ...
    <div class="row text-center">
        ...
        <div class="col-md-12 my-3  mb-2"><button type="button" id="addNewProd" class="btn fs-6 btn-danger">Ajouter un export de stock</button></div>
        <div class="col-md-12">
          ...
          <div class="modal-body">
            ...
            <form  class="form-horizontal" novalidate action="{{ url('out') }}" method="post">
              ...
              <div class="text-center m-5">
                <button type="submit" class="btn btn-primary" id="btn-save" value="addNewprod">Save changes</button>
              </div>
            </form>
          </div>
