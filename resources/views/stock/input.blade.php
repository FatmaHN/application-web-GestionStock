...
<div class="container mt-2">
    <div class="text-center m-2 row">
        <div class="col-md-12 text-center font-weight-bold">
          <h2 class="mt-5 text-center">Entrée De Stock</h2>
        </div>
        <div class="col-md-12 my-3 "><button type="button" id="addNewProd" class="btn fs-6 btn-success">Ajouter un apport de stock</button></div>
        <div class="col-md-12">
          ...
          <div class="modal-body">
            ...
            <form  class="form-horizontal" novalidate action="{{ url('add') }}" method="post">
              ...
              <div class="text-center m-5">
                <button type="submit" class="text-center btn btn-primary" id="btn-save" value="addNewProd">Save changes</button>
              </div>
            </form>
          </div>
